function a2s(a){
    ...
    if (!!a){
        if (!!a.city){
            _a.push(typeof a.city === "object" ? a.city.name : a.city);
        } else if (!!a.village){
            _a.push(typeof a.village === "object" ? a.village.name : a.village);
        } else if (!!a.county){
            _a.push(typeof a.county === "object" ? a.county.name : a.county);
        }
        if (!!a.street){
